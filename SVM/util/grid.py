...
class GridOption:
	def __init__(self, dataset_pathname, options):
		...
		if sys.platform != 'win32':
			self.svmtrain_pathname = '/home/victor/miniconda3/envs/ser-gmm/bin/svm-train'
			self.gnuplot_pathname = '/home/victor/miniconda3/envs/ser-gmm/bin/gnuplot'
		else:
			# example for windows
...
if __name__ == '__main__':
	...
	def exit_with_help():
		print("""\
Usage: grid.py [grid_opptions] [svm_options] dataset
...
svm_options : additional options for svm-train""")
	...
	try:
		print("fold Type: {} | num:{}".format(foldT, num))
		print(dataset_pathname)

		dataset_name=dataset_pathname.split('/')[1]
		print(dataset_name)

		best_rate, best_param = find_parameters(dataset_pathname, options)
		# best_param = {'c': 8.0, 'g': 0.001}
